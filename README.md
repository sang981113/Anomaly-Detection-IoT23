...
* This paper proposed an anomaly detection system model for IoT security with the implementation of ML/DL methods. 
...
## Models
There are total of 3 models are implemented in this project:  
* DNN
* LSTM
* GRU
